...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ar norite perziureti kokios nnors grupes studentus? ( y/n)");
        ...
        if (choice == "y") {
            ...
            list.removeIf(studentai -> !studentai.getGrupe().equals(group));
            System.out.println(list);
        } else {

            System.out.println("________________________");
            Comparator.comparing(Studentai::getVidurkis);
            System.out.println(list);
        }
    }
}