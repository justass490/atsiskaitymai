...
public class StudentaiImpl implements Comparable {
    ...
    public StudentaiImpl(long pazymejimoNr, String vardasPavarde, String gimimoData, String grupe, double vidurkis) {
    ...
    @Override
    public int compareTo(Object ateate) {
        return Comparator
                .comparing(StudentaiImpl::getVidurkis)
                .reversed()
                .compare(this, (StudentaiImpl) ateate);
    }
}