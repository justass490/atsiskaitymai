...
public class DarbininkaiImpl implements Comparator {
        ...
        public DarbininkaiImpl(String vardas, String detale, int detaliuKiekis, int detalesKaina){
            this.vardas = vardas;
            this.detale = detale;
